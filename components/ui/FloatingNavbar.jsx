...
const FloatingNavbar = ({ navItems, className = "", activeNavItem, onAddAccount, onRefresh, isRefreshing, accountSearchTerm, setAccountSearchTerm, videoSearchTerm, setVideoSearchTerm }) => {
  ...
  return (
    <nav
      className={`fixed top-4 left-[calc(45%)] transform -translate-x-1/2 z-50 flex max-w-7xl w-full items-center space-x-4 rounded-xl px-4 py-3 backdrop-blur shadow-[0_20px_45px_rgba(8,11,24,0.55)] transition-all duration-300 sm:px-6 sm:py-4 ${
